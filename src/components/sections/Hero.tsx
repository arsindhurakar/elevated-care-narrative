      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
          ...
          <div className="col-span-12 lg:col-span-7 order-2 lg:order-1">
            <p className="eyebrow reveal">Obstetrician & Gynecologist · Est. 2001</p>
            ...
            <div className="mt-10 grid grid-cols-12 gap-6">
              <p className="col-span-12 md:col-span-8 text-lg md:text-xl leading-relaxed text-graphite max-w-[54ch] reveal" style={{ animationDelay: "180ms" }}>
                Dr. Sony Sherpa is a consultant obstetrician and gynecologist with
                twenty-three years devoted to high-risk pregnancy, minimally
                invasive surgery, and the advancement of respectful maternity
                care across South Asia.
              </p>
          ...
          <div className="col-span-12 lg:col-span-5 order-1 lg:order-2 lg:-mt-16">
            <figure className="relative">
              ...
              <figcaption className="mt-4 flex items-baseline justify-between gap-4">
                <span className="eyebrow">Portrait — Kathmandu, 2024</span>
